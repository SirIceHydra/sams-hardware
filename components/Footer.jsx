    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Power Tools", path: '/', icon: null },
                { text: "Hand Tools", path: '/', icon: null },
                { text: "Smart Home", path: '/', icon: null },
                { text: "Safety Gear", path: '/', icon: null },
            ]
        },
        {
            title: "COMPANY",
            links: [
                ...
                { text: "Become Pro Member", path: '/pricing', icon: null },
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            Sam's<span className="text-orange-500">Hardware</span><span className="text-orange-500 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to Sam's Hardware, your ultimate destination for professional tools, reliable hardware, and smart home technology. We build trust with every tool.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © Sam's Hardware All Right Reserved.
                </p>
            </div>
        </footer>
    );
