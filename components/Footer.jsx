    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Power Tools", path: '/department/powertools' },
                { text: "Hand Tools", path: '/department/handtools' },
                { text: "Electrical", path: '/department/electrical' },
                { text: "Plumbing", path: '/department/plumbing' },
            ]
        },
        {
            title: "COMPANY",
            links: [
                ...
                { text: "Become Pro Member", path: '/pricing' },
        ...
        },
        {
            ...
            links: [
                ...
                { text: "+27 123 456 789", path: 'tel:+27123456789', icon: PhoneIcon },
                { text: "info@samshardware.co.za", path: 'mailto:info@samshardware.co.za', icon: MailIcon },
        ...
        <footer ref={footerRef} className="bg-[var(--te-dark)] relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
                ...
                <div ref={linksRef} className="flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-16 py-16 border-b border-[var(--te-grey-500)]">
                    ...
                    {/* Links columns */}
                    <div className="grid grid-cols-2 sm:grid-cols-3 w-full lg:w-auto gap-8 sm:gap-12">
                                ...
                                <ul className="space-y-4">
                                    {section.links.map((link, i) => (
                                        <li key={i}>
                                            <Link 
                                                href={link.path} 
                                                className="group flex items-center gap-2 text-base text-[var(--te-grey-400)] hover:text-[var(--te-white)] transition-colors"
                                            >
                                                {link.icon && <link.icon />}
                                                ...
                                                <ArrowUpRight size={12} className="opacity-0 group-hover:opacity-100 -translate-y-1 translate-x-1 group-hover:translate-y-0 group-hover:translate-x-0 transition-all text-[var(--te-yellow)]" />
                                            </Link>
                                        </li>
                                    ))}
                                </ul>
