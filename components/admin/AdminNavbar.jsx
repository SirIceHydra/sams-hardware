    ...
    return (
        <div className="flex items-center justify-between px-4 sm:px-8 py-3 bg-[var(--te-dark)] border-b border-[var(--te-grey-500)]">
            <Link href="/" className="flex items-center gap-3">
                ...
                {/* Admin badge */}
                <span className="ml-2 text-[9px] font-bold px-2 py-1 rounded-sm bg-[var(--te-cyan)] text-[var(--te-dark)] tracking-widest uppercase">
                    Admin
                </span>
            </Link>
            <div className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-[var(--te-grey-300)] font-medium tracking-wide">Hi, Admin</span>
                </div>
            </div>
        </div>
    )
